...
public class PathManager : MonoBehaviour {
	...
	*/
	...
	public void GoToSpawn(){
		...
		MoveToOnAxis (homePos);
		
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* 
		Using one of the navigation colliders attempt to walk around an object based on the collider that was hit.
		Will walk along walls counter clockwise until around object.
	*/
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* 
		Moves only on the axis pending exterior forces.
		Accounts for obstacle navigation.
		Attempts to compensate for navigation done away from the the target destination.
	...
	*/
	...
	//Move to with object if required.
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* 
		Checks for line of site with the player.
		Used for path logic and player detection.
		Uses line casting and bit masks.
	*/
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* 
		Sets the collision direction for obstacle pathing.
	*/
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* 
		Refactored function to check the difference between the the PLAYERS current position with last postion by
		referencing the change in position with the vector magnitudes.
	*/
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	float diffPos(){
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* 
		Setup the colliders on this AI prefab.
	*/
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
