...
public class ProceduralAI : MonoBehaviour {
	...
	*/
	...
	private void AssignStats(int[] split, GameObject stats){
		if (numOfStats < 3) {
			return;
		}	
		...
		//print (toSet.health.ToString ());
		//print (toSet.strength.ToString ());
		//print (toSet.intellect.ToString ());
	}
